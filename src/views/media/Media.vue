            ...
            <transition name="slide">
                <CCard>
                    <CCardBody>
                        ...
                        >
                            <template #name="{item}">
                                <td v-if="item.type == 'folder'" v-on:click="clickOnElement(item.id, item.type)"
                                    class="click-file">
                                    <CIcon :content="$options.folderIcon"/>
                                    {{ item.name }}
                                </td>
                            ...
                            <template #actions="{item}">
                                ...
                                <td v-if="item.type == 'file'">
                                    <CButton v-if="item.mime.includes('image/')" color="success"
                                             @click="openCroppFileModal(item.id)">
                                        Cropp
                                    </CButton>
                                </td>
                                <td v-else>
...
<script>
    ...
    import {cilFile, cilFolder, cilLevelUp, cilPlus} from '@coreui/icons'
